...
ProfessionalDD.getLayout = (page) => {
  return <PageLayout>{page}</PageLayout>;
};
export default ProfessionalDD;

export async function getStaticProps() {
  const items = await getCategoryByName('profesionalne suszarko - suszarki');
  return {
    props: {
