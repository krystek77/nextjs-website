...
const data = [
  ...
  },
  {
    ...
    path: "/urzadzenia-pralnia",
    content: [{ path: "pralnicowirowki/RX_G200/RX-65", label: "seria RX, 6.5-35 kg" }],
  },
  {
    id: 3,
    title: "Pralnicowirówki",
  ...
  return (
    <React.Fragment>
      ...
      <Banner classes='banner__washerExtractors'>
        <Title variant='h1' content='Innowacyjne pralnicowirówki przemysłowe' classes='title_maxWidth_960 title_bg_white_red' />
