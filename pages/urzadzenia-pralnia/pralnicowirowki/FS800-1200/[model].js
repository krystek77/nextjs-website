/*
 * http://localhost:3000/urzadzenia-pralnia/pralnicowirowki/FS800-1200/FS800
 */
  ...
  return (
    <React.Fragment>
      ...
      <Banner classes='banner__washerExtractors_FS800'>
        <Title variant='h1' content='Seria FS o załadunku od 80 kg do 120 kg' classes='title_maxWidth_960 title_bg_white_red' />
        <PageIndicator label='pralnicowirówki wysokoobrotowe FS' variant='red' />
      </Banner>
      <main>
