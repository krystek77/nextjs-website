...
const description =
  'Przemysłowe pralnicowirówki i suszarki w wykonaniu morskim 🚢, do pracy w trudnych warunkach atmosferycznych, idealne na statki jak i okręty wojenne';
function Navy() {
  return (
    <React.Fragment>
      <HeadMetaTags
      ...
      <Banner classes="banner__navy banner_height_auto">
        <Title
          classes="title_center title_light_500 title_maxWidth_960"
          content="Wyposażenie pralnicze dla marynarki wojennej i wojska"
        />
        <Description
