      ...
      <div className={styles.ourLaundries}>
        ...
        <form className={styles.ourLaundries__form} onSubmit={handleForm}>
          <div className={styles.ourLaundries__inputGroup}>
            ...
            <div className={styles.ourLaundries__inputWrapper}>
              {/** potential component */}
              <textarea className={styles.ourLaundries__description} onChange={(e) => setFormData({ ...formData, desc: e.target.value })} value={formData.desc} name='desc' rows='10' placeholder='Krótki opis dostarczonego wyposażenia' />
            ...
            <div className={styles.ourLaundries__inputWrapper}>
              <FileBase64 multiple={false} onDone={({ base64 }) => setFormData({ ...formData, image: base64 })} />
              <InputError isError={errors.selectedFileBase64} message='Zdjęciem musi zostać dodane' classes='inputError_top_minus_1_5' />
