      ...
      <div className={styles.contactFormSection__container}>
        <header className={styles.contactFormSection__header}>
          ...
          <Description classes='description_maxWidth_960 description_18'>
            Masz pytania dotyczące przemysłowych urządzeń pralniczych marki <strong>Pralma</strong> lub <strong>Primus</strong>? Aby uzyskać pomoc techniczną, rozwiązć problemy z eksploatcją, konserwacją urządzeń, zapytać o ofertę na odpowiednie do Twoich potrzeb wyposażenie pralnicze lub masz inne
            pytania dotyczące naszej współpracy lub dokumnetów, wypełnij i prześlij poniższy formularz.
          </Description>
        </header>
