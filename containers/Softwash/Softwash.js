  ...
  return (
    <section className={styles.softwash}>
      <div className={styles.softwash__image}>
        <Image
          src="/assets/images/bg_softwash.png"
          alt="delikatne pranie - softwash"
          width="960"
          height="700"
        />
      </div>
      <div className={styles.softwash__content}>
        ...
        <Title
          content="Witaj w Twojej przyszłej pralni"
          classes="title_maxWidth_640"
        />
        <Description
        ...
        <Description classes="description_18 description_maxWidth_760 ">
          <span>
            Technologia <strong>Soft Wash</strong> pozwala wykorzystać ten
            trend. <strong>Soft Wash</strong> to pakiet szyty na miarę, który
            umożliwia wyczyszczenie nawet najdelikatniejszej bielizny. Tworzy
            nowe możliwości w segmentach rynku, takich jak pralnie chemiczne,
            domy opieki, usługi ratunkowe itp.
          </span>
        </Description>
