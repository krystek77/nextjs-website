export const links = [
  ...
  },
  {
    ...
    submenu: [
      {
        label: 'Pralnicowirówki',
        path: 'urzadzenia-pralnia-samoobslugowa/pralnicowirowki',
      },
      { label: 'Suszarki', path: 'urzadzenia-pralnia-samoobslugowa/suszarki' },
      {
        label: 'Prasownice',
        path: 'urzadzenia-pralnia-samoobslugowa/prasownice',
      },
      {
        label: 'Profesjonalne pralnico - suszarki',
        path: 'urzadzenia-pralnia-samoobslugowa/profesionalne-pralnico-suszarki',
      },
      {
        label: 'Profesjonalne suszarko - suszarki',
        path: 'urzadzenia-pralnia-samoobslugowa/profesjonalne-suszarko-suszarki',
      },
      {
        label: 'Małe komercyjne pralnicowirówki',
        path: 'urzadzenia-pralnia-samoobslugowa/male-komercyjne-pralnicowirowki',
      },
      {
        label: 'Małe komercyjne suszarki',
        path: 'urzadzenia-pralnia-samoobslugowa/male-komercyjne-suszarki',
      },
      {
        label: 'Przemysłowe zestawy suszące',
        path: 'urzadzenia-pralnia-samoobslugowa/przemyslowe-zestawy-suszace',
      },
    ],
  },
