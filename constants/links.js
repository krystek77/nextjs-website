export const links = [
  ...
  },
  {
    ...
    submenu: [
      { label: "Pralnicowirówki", path: "urzadzenia-pralnia-samoobslugowa/pralnicowirowki" },
      { label: "Suszarki", path: "urzadzenia-pralnia-samoobslugowa/suszarki" },
      { label: "Prasownice", path: "urzadzenia-pralnia-samoobslugowa/prasownice" },
      {
        label: "Profesjonalne pralnico - suszarki",
      ...
      { label: "Małe komercyjne suszarki", path: "urzadzenia-pralnia-samoobslugowa/male-komercyjne-suszarki" },
    ],
  },
