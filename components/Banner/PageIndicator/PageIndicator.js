...
function PageIndicator({ label, classes, variant }) {
  ...
  return variant === 'white' ? (
    <p className={classesString}>
      <Image
        src="/assets/icons/page_indicator_light.svg"
        alt="wskaźnik"
        width="16"
        height="16"
      />
      <span
        className={`${styles.pageIndicator__label} ${styles.pageIndicator__label_white}`}
      >
        {label}
      </span>
    </p>
    ...
    <p className={classesString}>
      <Image
        src="/assets/icons/page_indicator_red.svg"
        alt="wskaźnik"
        width="16"
        height="16"
      />
      <span
        className={`${styles.pageIndicator__label} ${styles.pageIndicator__label_red}`}
      >
        {label}
      </span>
    </p>
    ...
    <p className={classesString}>
      <Image
        src="/assets/icons/page_indicator_dark.svg"
        alt="wskaźnik"
        width="16"
        height="16"
      />
