    ...
    <div className={styles.tabs}>
      ...
      {data.map((_, index) => {
        return indexes.includes(index) ? (
          <div
            key={index}
            className={`${styles.tabs__contentTab} ${styles.tabs__contentTab_active}`}
          >
            <ProductCard
              parent="/urzadzenia-pralnia"
              path="/pralnicowirowki/FX105-280/FX105"
            >
              <Label
                label="FX105-280"
            ...
            <ProductCard
              parent="/urzadzenia-pralnia"
              path="/pralnicowirowki/FX350-600/FX350"
            >
              <Label
            ...
            <ProductCard
              parent="/urzadzenia-pralnia"
              path="/pralnicowirowki/FS800-1200/FX800"
            >
              <Label
