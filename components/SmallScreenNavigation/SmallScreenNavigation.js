...
function SmallScreenNavigation() {
  ...
  return (
    <div className={styles.smallScreenNavigation}>
      <button
        onClick={open}
        className={`${styles.smallScreenNavigation__button} ${styles.smallScreenNavigation__button_open}`}
        type="button"
      >
        <Image
      ...
      {isMenuOpen && (
        <div className={styles.smallScreenNavigation__container}>
          <div className={styles.smallScreenNavigation__topbar}>
            <button
              onClick={close}
              className={`${styles.smallScreenNavigation__button} ${styles.smallScreenNavigation__button_close}`}
              type="button"
            >
              <Image
                ...
                height="16"
              />
              <span className={styles.smallScreenNavigation__caption}>
                CLOSE
              </span>
            </button>
          </div>
            ...
            {links.map((link, index) => {
              return (
                <React.Fragment key={`menu_${index + 1}`}>
                  <button
                    className={styles.smallScreenNavigation__header}
                    type="button"
                  >
